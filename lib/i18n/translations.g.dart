...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final _TranslationsExampleEn example = _TranslationsExampleEn._(_root);
}

// Path: example
class _TranslationsExampleEn {
	_TranslationsExampleEn._(this._root);
...
class _TranslationsFr extends Translations {
	...
	// Translations
	@override late final _TranslationsExampleFr example = _TranslationsExampleFr._(_root);
}

// Path: example
class _TranslationsExampleFr extends _TranslationsExampleEn {
	_TranslationsExampleFr._(_TranslationsFr root) : this._root = root, super._(root);

	@override final _TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String hello({required Object name}) => 'Bonjour ${name}';
